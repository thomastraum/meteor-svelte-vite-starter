    ...
    >
      <div class="w-full flex-1 md:w-auto md:flex-none">
        <button
          type="button"
          tabindex="0"
          class="focus-visible:ring-ring inline-flex items-center whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50 border-input bg-background hover:bg-accent hover:text-accent-foreground border shadow-sm h-9 px-4 py-2 text-muted-foreground relative w-full justify-start text-sm sm:pr-12 md:w-40 lg:w-64"
          data-button-root=""
